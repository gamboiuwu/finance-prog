...
export default function Transactions({ token }) {
  ...
  return (
    <div className="stagger p-4 pb-24 space-y-4">
      ...
      {/* Search bar */}
      <div role="search" aria-label="Search transactions" className="relative">
        <span aria-hidden="true" className="absolute left-3 top-1/2 -translate-y-1/2 text-slate-500 pointer-events-none">
      ...
      {filteredRows.length > 0 && (
        <div className="grid grid-cols-3 gap-2" role="region" aria-labelledby="filtered-totals-heading" tabIndex={0}>
          <h2 id="filtered-totals-heading" className="sr-only">Filtered totals</h2>
      ...
      {filteredRows.length > 0 && (
        <div role="region" aria-labelledby="summary-totals-heading" tabIndex={0}
             className="bg-slate-800/60 rounded-2xl p-4 border border-slate-700/40">
          <h2 id="summary-totals-heading" className="sr-only">Summary totals</h2>
