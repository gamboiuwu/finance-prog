      ...
      <button className="w-full text-left" onClick={onToggle}>
        <div className="flex items-start justify-between gap-3">
          <div>
            ...
            <span
              className={`inline-flex items-center gap-1 mt-1.5 px-2 py-0.5 rounded-full border text-[10px] font-medium ${confidence.tint}`}
              aria-label={`Projection confidence: ${confidence.label} — ${confidence.note}`}
            >
